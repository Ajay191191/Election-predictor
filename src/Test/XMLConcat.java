...
public class XMLConcat {
	public static void main(String[] args) throws Throwable {
		...
		// FileWriter("/home/ajay/Project/mergedFile.xml");
		// XMLOutputFactory xmlOutFactory = XMLOutputFactory.newFactory();
		// XMLEventWriter xmlEventWriter =
		// xmlOutFactory.createXMLEventWriter(outputWriter);
		// XMLEventFactory xmlEventFactory = XMLEventFactory.newFactory();
		//
		// xmlEventWriter.add(xmlEventFactory.createStartDocument());
		// xmlEventWriter.add(xmlEventFactory.createStartElement("", null,
		// "rootSet"));
		//
		// try{
		...
		// XMLEventReader xmlEventReader = xmlInFactory.createXMLEventReader(new
		// StreamSource(rootFile));
		...
		// }
		//
		// xmlEventWriter.add(xmlEventFactory.createEndElement("", null,
		// "rootSet"));
		...
		// {
		// try (FileChannel in = new FileInputStream(new File(dir,
		// file).getChannel()))
		// {
